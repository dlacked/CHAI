...
def main():
    ...
    parser = argparse.ArgumentParser(description="Build offline arch-geometry cache (with theta) for the ViT arch-complexity classifier's theta ablation baseline.")
